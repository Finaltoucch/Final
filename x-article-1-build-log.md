...
**Claude** is the agent. It writes the shot list, holds the story straight across eleven shots, and calls the tools.

**Higgsfield through MCP** is the generator. MCP is the part most people miss. It isn't Claude *describing* how to make a video. It's Claude *operating* the video tool directly: submitting jobs, polling them, pulling results, assembling the final cut. You talk. It builds.
...
Including my mistakes and reruns, the entire session came to roughly 253 credits.
